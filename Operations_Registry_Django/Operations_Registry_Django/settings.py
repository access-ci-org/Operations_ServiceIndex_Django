"""
Django settings for Operations_Registry_Django project.
...
ROOT_URLCONF = 'Operations_Registry_Django.urls'
...
WSGI_APPLICATION = 'Operations_Registry_Django.wsgi.application'
