...
urlpatterns = [
    ...
    re_path(r"^edit/(?P<service_id>\d+)$", views.edit_service, name="edit_service"),
    path("update/", views.update_service, name="update_service"),
    re_path(r"^hosts/(?P<order_field>\w+)$", views.hosts, name="hosts"),
    path("people/", views.people, name="people"),
    re_path(r"^edit_staff/(?P<staff_id>\d+)$", views.edit_staff, name="edit_staff"),
    ...
    re_path(r"^event/(?P<event_id>\d+)$", views.event, name="event"),
    re_path(r"^update_event/(?P<hes_id>\d+)$", views.update_event, name="update_event"),
