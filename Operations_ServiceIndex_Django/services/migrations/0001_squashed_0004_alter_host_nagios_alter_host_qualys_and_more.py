...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("services", "0004_alter_host_nagios_alter_host_qualys_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="services.event"
                    ),
                ),
                (
                    "host",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="services.host"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="services.site"
            ),
        ),
        migrations.AddField(
            model_name="host",
        ...
        migrations.AddField(
            ...
            name="support",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="services.support"
            ),
        ),
        migrations.AddField(
            model_name="host",
